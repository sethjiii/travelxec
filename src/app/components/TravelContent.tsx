      ...
      <section className="relative h-[650px] md:h-[750px] lg:h-[800px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-black/30 flex items-center">
          <div className="text-white px-8 md:px-16 max-w-2xl">
            ...
            <p className="text-lg md:text-xl mb-8 text-[#8c7361] font-milchella">
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    <div className="mt-auto pt-6">
                      <div className="flex flex-col gap-3">
                        ...
                        <button className="w-full border border-[#8C7361]/40 text-[#8C7361] hover:bg-[#D2AF94]/10 hover:border-[#8C7361] hover:text-[#002D37] py-3 px-6 rounded-xl font-light transition-all duration-300 flex items-center justify-center gap-2 group/save">
                          <Bookmark className="w-4 h-4 transition-transform duration-300 group-hover/save:scale-110" />
                          <span>Curate</span>
                        </button>
                      </div>
                    </div>
              ...
              <SwiperSlide key={pkg._id}>
                <div className="group bg-white/70 backdrop-blur-md rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-700 overflow-hidden border border-[#A6B5B4]/20 hover:border-[#186663]/30 hover:bg-white/85 transform hover:translate-y-[-4px] h-[440px] flex flex-col justify-between">
                  ...
                  <div className="relative overflow-hidden h-48">
                    ...
                    <button className="absolute top-4 right-4 p-2.5 bg-white/90 backdrop-blur-sm rounded-full shadow-lg hover:bg-white hover:scale-110 transition-all duration-300 border border-[#A6B5B4]/20">
                      <Heart className="h-4 w-4 text-[#8C7361] hover:text-red-500 transition-colors duration-300" />
                    </button>
                  </div>
