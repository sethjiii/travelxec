...
import { Package, Calendar, Sparkles, ChevronRight, CalendarX, Plane } from "lucide-react";

const AdminDashboard = () => {
  const [hoveredButton, setHoveredButton] = useState<'package' | 'bookings' | 'itinerary' | 'adddestination' | null>(null);
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 relative overflow-hidden py-24">
      ...
      <div className="container mx-auto px-4 py-10 relative z-10">
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
          <Link href="/admin/dashboard/" className="group w-full">
            <div
          ...
          <Link href="/admin/bookings" className="group w-full">
            <div
          ...
          <Link href="/admin/itineraries" className="group w-full">
            <div
          ...
          <Link href="/admin/adddestination" className="group w-full">
            <div
              className="relative bg-slate-800/50 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 hover:bg-slate-800/70 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-emerald-500/20 cursor-pointer overflow-hidden"
            ...
            >
              ...
              <div className="relative z-10 text-center">
                ...
                <p className="text-slate-400 mb-6 leading-relaxed">
                  Add a new travel destination to the database
                </p>
                <div className="inline-flex items-center text-green-400 group-hover:text-green-300 transition-colors font-medium">
                  <span>Open</span>
                  <ChevronRight className={`w-5 h-5 ml-2 transition-transform duration-300 ${hoveredButton === 'adddestination' ? 'translate-x-1' : ''}`} />
                </div>
              </div>
            </div>
          </Link>
